		...
		<div class="woocommerce-product-gallery__wrapper">
	        ...
	        if ($order) {
	            ...
	            foreach ($order->get_items() as $item_id => $item) {
	                ...
	                $thumbnail = (isset($getThumb[0]) ? $getThumb[0] :''); 
	            ...
	            if (!empty($thumbnail)) {
	         		echo '<img src="'.$thumbnail.'" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" loading="lazy" width="300" height="300">'; 
	            }
        	}
		    ?>
		</div>
