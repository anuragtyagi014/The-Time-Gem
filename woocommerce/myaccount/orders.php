...
<?php else : ?>
	...
	<?php wc_print_notice( esc_html__( 'No order has been made yet.', 'woocommerce' ) . ' <a class="woocommerce-Button button" href="'.get_site_url().'/pricing/">Get Time Gem</a>', 'notice' ); // phpcs:ignore WooCommerce.Commenting.CommentHooks.MissingHookComment ?>

<?php endif; ?>

<?php do_action( 'woocommerce_after_account_orders', $has_orders ); ?>
<?php
	//echo WC_Payments_Features::is_upe_deferred_intent_enabled();
?>